<template>
	<view class="uni-load-more" @click="onClick">
		...
		<svg width="24" height="24" viewBox="25 25 50 50" v-if="!webviewHide && (iconType==='circle' || iconType==='auto' && platform === 'android') && status === 'loading' && showIcon" :style="{width:iconSize+'px',height:iconSize+'px'}" class="uni-load-more__img uni-load-more__img--android-H5">
			<circle class="uni-load-circle" cx="50" cy="50" r="20" fill="none" :style="{color:color}" :stroke-width="3"></circle>
		</svg>
		<!-- #endif -->
		<!-- #ifndef APP-NVUE || H5 -->
		<view v-if="!webviewHide && (iconType==='circle' || iconType==='auto' && platform === 'android') && status === 'loading' && showIcon" :style="{width:iconSize+'px',height:iconSize+'px'}" class="uni-load-more__img uni-load-more__img--android-MP">
			<view class="uni-load-mp-view" :style="{borderTopColor:color,borderTopWidth:iconSize/12}"></view>
			<view class="uni-load-mp-view" :style="{borderTopColor:color,borderTopWidth:iconSize/12}"></view>
			<view class="uni-load-mp-view" :style="{borderTopColor:color,borderTopWidth:iconSize/12}"></view>
		</view>
		<!-- #endif -->
...
<style scoped>
	...
	.uni-load-more__img--ios-H5>.uni-load-img {
		position: absolute;
		width: 100%;
		height: 100%;
		left: 0;
	...
	.uni-load-more__img--android-H5>.uni-load-circle {
	...
	.uni-load-more__img--android-MP>.uni-load-mp-view {
		position: absolute;
	...
	.uni-load-more__img--android-MP>.uni-load-mp-view:nth-child(1) {
		animation: loading-android-MP-1 1s 0s linear infinite;
	}

	.uni-load-more__img--android-MP>.uni-load-mp-view:nth-child(2) {
		animation: loading-android-MP-2 1s 0s linear infinite;
	}

	.uni-load-more__img--android-MP>.uni-load-mp-view:nth-child(3) {
